...
onMounted(async () => {
  ...
  try {
    ...
    features.value = [
      { id: "spec-clarify", name: "Spec Clarify", version: "1.0.0", description: "Analyze and clarify spec documents against source code or wiki", icon: "🔍", category: "documentation", author: "copilothub", type: "builtin", frontendRoute: "/features/spec-clarify" },
      { id: "wiki", name: "Wiki", version: "1.0.0", description: "Chat and manage project knowledge across local projects", icon: "📚", category: "knowledge", author: "copilothub", type: "builtin", frontendRoute: "/features/wiki" },
    ];
  }
});
...
<template>
  <div class="min-h-screen bg-background text-foreground">
        ...
        <div>
          ...
          <div v-if="repoStore.info" class="mt-1 space-y-1">
            ...
            <div class="flex items-center gap-3 flex-wrap">
              <span
                v-if="repoStore.info.currentBranch"
              ...
              <a
                v-if="repoStore.info.remoteOrigin"
    ...
    <main class="px-6 py-8 max-w-4xl mx-auto">
      <section>
        <h2 class="text-sm font-semibold text-muted-foreground uppercase tracking-wide mb-4">Built-in Features</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div class="border border-dashed border-border rounded-lg p-5 flex flex-col items-center justify-center gap-2 text-center text-muted-foreground cursor-default">
      ...
      <section v-if="features.some((f) => f.type === 'external')" class="mt-10">
        <h2 class="text-sm font-semibold text-muted-foreground uppercase tracking-wide mb-4">Installed Features</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div
